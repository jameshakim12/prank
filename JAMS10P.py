...
if (six.PY2):
    ...
    import urllib.parse
acil = LINETCR.LINE()
acil.login(token="EvjEKN3iR9hZRT5169B4.B3NUiUU2URbQQwCanZpj1a.CiFuHqFFVkxO7dt7ViGC5sXbP9xmMoPu9FNh/ngAAa4=")
acil.loginResult()
ki = LINETCR.LINE()
    ...
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
                ...
                acil.sendText(msg.to,"『⊰์◉⊱Like Sukses⊰์◉⊱』")
#-----------------------------------------------
        if op.type == 11:
            if op.param3 == '1':
